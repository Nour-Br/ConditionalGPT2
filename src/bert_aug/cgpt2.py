...
GPT2_MODEL = 'flax-community/gpt2-medium-persian'
EOS_TOKEN = '<|endoftext|>'
SEP_TOKEN = '<SEP>'
...
def main():
    ...
    parser.add_argument("--task_name", default="snips", type=str,
...
def augment_train_data(model, tokenizer, train_examples, args):
    ...
    tsv_writer = csv.writer(save_train_file, delimiter='\t', quoting=csv.QUOTE_NONE,  quotechar='',escapechar='\\')
...
def train_cmodgpt2_and_augment(args):
    ...
    train_examples = processor.get_test_examples()
